...
declare function createEchoStats(
    appName: string,
    counterName: string,
    options: EchoStatsOptions): any; // Returns EchoClient which is very complicated object.

declare interface EmbedVars {
...
declare type ActionName = "game_loaded" |
                          "game_first_click" |
                          "game_click" |
                          "timer" |
                          "game_level";
